    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="flex flex-col items-center border-t border-slate-400/10 py-10 sm:flex-row-reverse sm:justify-between">
        <div className="flex gap-x-6">
          <a className="group" aria-label="Sxx on Twitter" href="https://twitter.com">
          ...
          <a className="group" aria-label="Sxx on GitHub" href="https://github.com">
            <svg aria-hidden="true" className="h-6 w-6 fill-slate-500 group-hover:fill-slate-700">
        ...
        <p className="mt-6 text-sm text-slate-500 sm:mt-0">Copyright © 2023 Sxx. All rights reserved.</p>
      </div>
    </div>
  </footer>
  );
